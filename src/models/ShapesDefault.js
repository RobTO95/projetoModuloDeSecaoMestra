...
export class TShapeBeam extends CustomShape {
	constructor(
		...
		this.anchor(0, 0);
		this.line(soulThickness / 2, 0);
		this.line(soulThickness / 2, soulLength);
		this.line(flangeLength / 2, soulLength);
		this.line(flangeLength / 2, soulLength + flangeThickness);
		this.line(0, soulLength + flangeThickness);
		this.line(-(flangeLength / 2), soulLength + flangeThickness);
		this.line(-(flangeLength / 2), soulLength);
		this.line(-(soulThickness / 2), soulLength);
		this.line(-(soulThickness / 2), 0);
